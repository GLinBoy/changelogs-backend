...
public class ChangeLogDTO extends BaseDTO {
	...
	@Builder
	public ChangeLogDTO(Long id, Boolean isActive, @Size(max = 32) @NotBlank(message = "Version number is mandatory") String versionNo,
			...
			@Email(regexp = "^[a-zA-Z0-9_+&*-]+(?:\\.[a-zA-Z0-9_+&*-]+)*@(?:[a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,7}$") @Size(min = 8, max = 64) @NotBlank(message = "Contact is mandatory") String contact,
